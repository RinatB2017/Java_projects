...
/**
 * *
 * Here is an example of shadow mapping with LWJGL and shaders. I'm an openGL
 * beginner and the code probably isn't ther best written but it works and
 * should be used as a guideline.
 *
 * Notice that the light is a point light and the shadows are made with
 * orthogonal projection (used for directional light) you might notice that the
 * shadow DOES NOT CORRESPOND TO A POINT LIGHT!
 *
 *
 *
 *
