...
public class Lesson05 {
    ...
    String windowTitle = "Test - 3D Shapes";
    ...
    private void draw_test() {
        ...
        GL11.glRotatef(triangleAngle, 1.0f, 0.0f, 0.0f);

        for (int n = 0; n < 10; n++) {
            GL11.glTranslatef(2.0f, 0.0f, 20.0f);
            for (int i = 0; i < 10; i++) {
                draw_triangles();
    ...
    private void renderGL() {
        ...
        GL11.glRotatef(quadAngle, 0.0f, 1.0f, 0.0f);    // Rotate The Cube On X, Y & Z
        draw_qards();
         */
        //---
    }
    ...
    // -Djava.library.path=/usr/lib64/lwjgl-2.9/
