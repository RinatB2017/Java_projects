...
public class Bot {
    ...
    public static int LV_FREE = 0;          // место свободно, здесь может быть размещен новый бот
    public static int LV_ORGANIC_HOLD = 1;  // бот погиб и представляет из себя органику в подвешенном состоянии
    public static int LV_ORGANIC_SINK = 2;  // органика начинает тонуть, пока не встретит препятствие, после чего остается в подвешенном состоянии(LV_ORGANIC_HOLD)
    public static int LV_ALIVE = 3;         // живой бот
    ...
    // ====================================================================
    public void step() {
        if (alive == Bot.LV_FREE || alive == Bot.LV_ORGANIC_HOLD || alive == Bot.LV_ORGANIC_SINK) {
